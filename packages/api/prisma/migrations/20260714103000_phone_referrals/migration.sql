...
-- Bevara gamla värvningar: deras `code` var delningskoden och telefonen
-- finns på respektive User-rad. Normalisera svenska 07/46/+46-varianter
-- innan unikhetsindexet skapas så samma kund inte kan värvas igen efter deploy.
