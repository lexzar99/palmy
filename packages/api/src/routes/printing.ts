...
const DEFAULT_TEMPLATE_ELEMENTS = [
  ...
  { key: 'platformName', label: 'Plattformsnamn (ViaEats)', visible: true, size: 8, weight: 'normal', align: 'center', uppercase: true },
  ...
  { key: 'headerMsg', label: 'Sidhuvud', content: '', visible: false, size: 9, weight: 'bold', align: 'center' },
  { key: 'divider2', label: 'Avdelare (efter sidhuvud)', visible: false, size: 8, weight: 'normal', align: 'center' },
  ...
  { key: 'orderType', label: 'Typ (Leverans/Avhämtning)', visible: true, size: 12, weight: 'black', align: 'center', uppercase: true },
  { key: 'scheduledFor', label: 'Förbeställd tid', visible: true, size: 12, weight: 'black', align: 'center' },
  { key: 'paymentMethod', label: 'Betalmetod', visible: true, size: 12, weight: 'black', align: 'center' },
  { key: 'estimatedTime', label: 'Utlovad tid (ETA)', visible: true, size: 14, weight: 'black', align: 'center' },
  ...
  { key: 'deliveryInstructions', label: 'Leveransinstruktioner', visible: true, size: 9, weight: 'bold', align: 'left' },
  ...
  { key: 'divider6', label: 'Avdelare (efter total)', visible: true, size: 8, weight: 'normal', align: 'center' },
