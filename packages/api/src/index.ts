...
import partnerApplicationsRoutes from './routes/partnerApplications';
...
(async () => {
  ...
  try {
    ...
    // Efter 3 min: stäm av AWAITING_PAYMENT mot PSP:n och radera raden när
    // betalningen bevisligen misslyckades. En betalning tar inte längre än så,
    // och en obetald order får inte ligga kvar i kundens historik. Kör varje
    // minut, så städningen sker efter cirka 3–4 minuter.
    ...
    setInterval(() => { void expireAbandoned(); }, 60 * 1000);
