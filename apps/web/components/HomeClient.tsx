...
export default function HomeClient({ initialData = null, partnerSlug = null }: { initialData?: HomeInitialData | null; partnerSlug?: string | null }) {
  ...
  const renderFeaturedRail = (title: string, subtitle: string | null | undefined, sectionRestaurants: Restaurant[], options: { alwaysShow?: boolean; priorityImageCount?: number } = {}) => {
    ...
    <section className="mb-5">
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar mx-0 px-0 md:mx-0 md:px-0 snap-x snap-mandatory">
        ...
        {query.trim() === "" && promoCards.length > 0 && (
          <section className="mb-5">
            ...
            <div
              ...
              className="flex items-start gap-3 overflow-x-auto pb-1 no-scrollbar mx-0 px-0 sm:mx-0 sm:px-0"
