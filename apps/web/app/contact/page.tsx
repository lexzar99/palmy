    ...
    <div className="pt-32 pb-24 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        {[
          ...
          const inner = (
            <div className="p-8 rounded-3xl bg-white/5 border border-white/5 hover:border-gold-500/20 transition-all group h-full">
              ...
              <div className="text-[10px] text-white/20 uppercase font-black tracking-widest mb-2">{item.title}</div>
      ...
      <div className="bg-white/5 border border-white/5 rounded-[2rem] p-10 text-center">
        <div className="text-3xl font-black uppercase tracking-tight mb-4">
          Vill du <span className="text-gold-500">beställa</span>?
        </div>
        <p className="text-white/40 mb-8">Prova vår digitala beställning – snabbt och smidigt.</p>
        <Link
          href="/menu"
