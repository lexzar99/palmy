          ...
          <div className="p-8 rounded-[3rem] bg-gold-500/5 border border-gold-500/10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl font-black italic mb-4 leading-[1.15]" style={{ color: "var(--text-primary)" }}>
                Delivera och dig.<br />Detta gäller när du beställer.
              </h2>
              <p className="leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                Genom att använda Delivera godkänner du dessa villkor. De är skrivna med svensk konsumentskyddslagstiftning som grund — Distansavtalslagen (2005:59), Konsumentköplagen (2022:260) och Dataskyddsförordningen (GDPR).
              </p>
            </div>
          </div>
          ...
          <div className="space-y-10 mt-12 px-2">
            ...
            <section className="space-y-4">
              ...
              <p className="text-[11px] leading-snug" style={{ color: "var(--text-secondary)", opacity: 0.7 }}>
                Delivera är en plattform som förmedlar din beställning till restaurangen. Köpeavtalet för maten du beställer ingås mellan dig och respektive restaurang.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                När du lägger en order via Delivera är beställningen bindande. Restaurangen påbörjar tillagningen så snart de bekräftat ordern. Priser anges inkl. moms. Eventuell leveransavgift visas tydligt innan du bekräftar köpet.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                All kortbetalning hanteras av Stripe (Stripe Payments Europe Ltd., PCI-DSS-certifierad). Delivera lagrar inga kortnummer eller CVC-koder — endast en token från Stripe används för att slutföra köpet. Vid återbetalning sker krediteringen till samma kort som användes vid köp.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                Enligt Distansavtalslagen 2 kap. 11 § har du normalt 14 dagars ångerrätt på distansavtal. <strong>Ångerrätten gäller dock inte för leverans av livsmedel eller andra varor som tillagats eller paketerats för en enskild beställning</strong> (2 kap. 11 § p. 4) — d.v.s. den färdiglagade maten du beställer via Delivera.
              </p>
              <p className="leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                Om något är fel på din mat — felaktig leverans, kall mat, allergiavvikelser eller liknande — ska du i första hand kontakta restaurangen direkt. Får du inte gehör hjälper Delivera gärna till via {" "}
                <a href={`mailto:${company.email}`} className="text-gold-500 underline">{company.email}</a>.
              </p>
            </section>
