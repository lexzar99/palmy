...
// TODO: Fyll i av Jalle innan launch — verifiera mot Bolagsverket-registret.
const COMPANY = {
  name: "MatGo AB",
  orgNr: "TODO-orgnr",
  address: "TODO-gatuadress, TODO-postnr TODO-ort",
  email: "support@matgo.se",
};
        ...
        >
          ...
          <div className="space-y-10 mt-12 px-2">
            ...
            <section className="space-y-4">
              ...
              {/* TODO: Fyll i av Jalle innan launch */}
              <div className="rounded-2xl p-5 space-y-2 text-sm" style={{ backgroundColor: "var(--bg-secondary)", border: "1px solid var(--border-muted)" }}>
                ...
                <div className="flex justify-between gap-4">
                  ...
                  <span style={{ color: "var(--text-primary)" }}>{COMPANY.orgNr}</span>
                </div>
                <div className="flex justify-between gap-4">
                  <span className="font-black uppercase tracking-widest text-[10px]" style={{ color: "var(--text-secondary)" }}>Adress</span>
                  <span className="text-right" style={{ color: "var(--text-primary)" }}>{COMPANY.address}</span>
                </div>
                <div className="flex justify-between gap-4">
