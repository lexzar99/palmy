...
export default function CommandPalette() {
  ...
  const commands: CommandItem[] = useMemo(
    () => [
      ...
      { id: "restaurant-ops", label: "Restauranghub", description: "Öppettider, ETA och admin-alias", icon: Store, action: () => router.push("/restaurant-ops"), category: "Navigation", keywords: ["hours", "öppettider", "hub"] },
