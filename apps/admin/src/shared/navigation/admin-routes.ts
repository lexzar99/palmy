...
export const ADMIN_ROUTES: AdminRouteDefinition[] = [
  ...
  route({ id: "restaurant-finance", href: "/finance/restauranger", label: "Restaurangekonomi", shortLabel: "Restaurangekonomi", icon: ReceiptText, section: "finance", keywords: "restaurang ekonomi payout rapport utbetalning provision moms snapshot lås" }),
