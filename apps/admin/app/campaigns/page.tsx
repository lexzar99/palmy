    ...
    <div className="min-h-screen bg-[#02040a] p-4 lg:p-10 text-white font-sans">
      <div className="max-w-[1000px] mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-white/20 text-xs font-bold uppercase tracking-widest mt-4">Välj vad du vill hantera för att komma igång.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           <Link href="/campaigns/restaurants" className="group relative bg-[#0a0c14] border border-white/5 rounded-[3rem] p-12 overflow-hidden transition-all hover:border-gold-500/30 hover:-translate-y-2">
              ...
              <p className="text-[11px] font-black text-white/20 uppercase tracking-widest leading-relaxed mb-10 max-w-[200px]">Hantera generella rabatter, kombodeals och erbjudanden som syns för alla på menyn.</p>
              <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-emerald-500">
                 Gå vidare <ArrowRight size={14} className="group-hover:translate-x-2 transition-transform" />
              </div>
           </Link>

           <Link href="/campaigns/customers" className="group relative bg-[#0a0c14] border border-white/5 rounded-[3rem] p-12 overflow-hidden transition-all hover:border-gold-500/30 hover:-translate-y-2">
              ...
              <p className="text-[11px] font-black text-white/20 uppercase tracking-widest leading-relaxed mb-10 max-w-[200px]">Skapa riktade kampanjer med personliga, telefon-låsta koder till specifika kundgrupper.</p>
