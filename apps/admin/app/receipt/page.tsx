...
const mockOrder = {
  ...
  deliveryZip: "223 50",
  note: "Ring på klockan om ni inte hittar.",
  createdAt: new Date().toISOString(),
  total: 278,
  deliveryFee: 49,
  items: [
    {
      productName: "Kebabpizza",
      quantity: 1,
      basePrice: 129,
      subtotal: 129,
      selectedExtras: [
        { groupName: "Storlek", extraName: "Panpizza" },
    ...
    },
    {
      ...
      basePrice: 100,
      subtotal: 100,
      selectedExtras: [{ groupName: "Pålägg", extraName: "Extra ost", priceAddon: 10 }],
      note: null,
    }
  ]
};
