...
(function () {
  ...
  function injectStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent =
      ".ve-embed-frame{display:block;width:100%;min-height:720px;border:0;background:transparent}" +
      ".ve-embed-loading{display:flex;align-items:center;justify-content:center;min-height:220px;color:#6b6b70;font:600 14px -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif}" +
  ...
  function init(host) {
    ...
    injectStyles();
    host.innerHTML = '<div class="ve-embed-loading">Laddar meny…</div>';
